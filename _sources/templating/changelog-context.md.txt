...
|---------------------|-------------------------------------|-----------------------------------------------------------------------------------------|
| config              | {class}`~.Configuration`            | The changelog generation configuration.                                                 |
| versions            | `list` of {class}`~.VersionContext` | The version contexts to render in the changelog.                                        |
